...
# Create a GNMT model.
model = trax.models.LSTMSeq2SeqAttn(
    input_vocab_size=32000,
    d_model=1024, attention_dropout = 0.2,
    n_attention_heads=1, n_encoder_layers=4, n_decoder_layers=4,
    mode='train')
...
output_dir = 'GNMT_DE_pretrained_336'
...
with open("hlo_files/hlo_trace_gnmt.txt", "w") as text_file:
  text_file.write(hlo_computation.as_hlo_text())
with open("hlo_files/hlo_trace_gnmt.pb", "wb") as proto_file:
